...
Task tracking is **spec-kit** (`specs/README.md`). Beads (`bd`) was retired 2026-08-21 —
its DB is a read-only archive; see the Rules block below.
...
<!-- BEADS CODEX SETUP removed 2026-08-21: beads retired, tracking is spec-kit (specs/README.md) -->
