...
- [ ] T009 [in-progress: worker-t009-serial] [US1] Registration (serial, master, after both lanes merge): additive ToolSpec batch for all US1 tools into the phase-D fragment (T003 seam) + per-module adapter blocks + envelope-gated write paths wired + registry smoke tests. Write: tool_registry.py, mcp_server.py, tests/test_mcp_tools.py. Read: seam layout from T003, session_tools.py/exercises.py APIs. [was: kata-d3]
